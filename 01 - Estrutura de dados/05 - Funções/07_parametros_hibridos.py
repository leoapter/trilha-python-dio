...
criar_carro("Palio", 1999, "ABC-1234", "Fiat", motor = "1.0", combustivel = "Gasolina") # Palio 1999 ABC-1234 Fiat 1.0 Gasolina
print()

# Declaração invalida; Foi declarado positional, onde está forcado keyword
criar_carro("Palio", 1999, "ABC-1234", "Fiat", "1.0", "Gasolina") # TypeError: criar_carro() takes 4 positional arguments but 6 were given
print()

# Declaração inválida, Foi declarado keyword (kargs --> chave=valor), onde está forcado positional
criar_carro(modelo="Palio", ano=1999, placa="ABC-1234", marca="Fiat", motor="1.0", combustivel="Gasolina")  # ypeError: criar_carro() got some positional-only arguments passed as keyword arguments: 'modelo, ano'
